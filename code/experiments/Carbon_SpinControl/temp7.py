...
# - (8/04) 무작정 z좌표를 낮춰서 Carbon |0> 에서 |1>로 보내는 코드. [temp7.py]
# %%
import numpy as np
...
df4.to_csv('/Users/qwon/Documents/data/NuclearSpinData/' + printdate +'_temp7.csv' ,index=False)
# %%