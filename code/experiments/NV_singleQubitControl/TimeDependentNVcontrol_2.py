# 4/12 박사님 미팅 후 수정안 만드는것
# 4/14 주피터노트북으로 작성한 TimeDependentNVcontrol_3.ipynb를 py로 옮긴것.
# 목표: 초안에서, gate Rz->Ry로 바꾸고, 최적화 알고리즘 (ex:GRAPE)사용해서, T내에 fidelity를 만족하는 gate조합 찾는것
